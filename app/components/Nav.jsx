...
export default function Nav() {
    ...
    return (<>
        <nav className={`bg-black bg-opacity-30 backdrop-filter backdrop-blur-md text-white text-center flex justify-between items-center fixed top-0 left-0 right-0 z-50 ${isScrolled ? 'p-1' : 'p-2'}`}>
