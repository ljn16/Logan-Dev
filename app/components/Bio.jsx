...
export default function Bio () {
    return (
        <div className="bio-container flex flex-col w-full bg-gradient-to-r from-black via-[#222222] to-black items-center justify-center p-4 space-y-4">
            ...
            <div className='border border-red-500 border-opacity-25 w-full flex flex-col items-center justify-center font-thin'>
                <p>I'm a full-stack developer from the midwest. These are some of my favorite technologies:</p>
                < Technologies />
            </div>
        </div>
    );
